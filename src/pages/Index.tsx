      ...
      <section className="py-24 relative z-[1]">
        <div className="max-w-[1040px] mx-auto px-5 md:px-9">
          ...
          <div className="flex flex-col gap-2">
            {[
              { num: "I", title: "Assessment", desc: "Realizamos uma avaliação inicial para entender seu momento, contexto e objetivos." },
              { num: "II", title: "Imersão para Nivelar Conhecimentos", desc: "Passamos por uma imersão para alinhar conceitos e garantir uma base sólida antes de avançar." },
              { num: "III", title: "Escolha do Melhor Plano", desc: "Com base no assessment e na imersão, definimos juntas o plano mais adequado para você." },
              { num: "IV", title: "Confirmação da Vaga", desc: "Confirme a inscrição e inicie sua jornada. As vagas são preenchidas por ordem de confirmação." },
            ].map((step, i) => (
